...
const getResultData = (total: number): ResultData => {
  if (total <= 3) {
    return {
      riskLevel: 'low',
      title: 'Low Risk',
      description: 'Sufficiency/Optimal Status (Likely > 30 ng/mL) - Your lifestyle and symptoms suggest you likely have sufficient Vitamin D levels. Great job maintaining healthy habits!',
      ...
      recommendations: [
        ...
        'Optional maintenance: Consider 1,000-2,000 IU daily for ongoing maintenance',
    ...
    return {
      riskLevel: 'moderate',
      title: 'Moderate Risk',
      description: 'Insufficiency Status (Likely 20-30 ng/mL) - Your responses suggest possible Vitamin D insufficiency. Some lifestyle modifications are recommended.',
    ...
    return {
      riskLevel: 'high',
      title: 'High Risk',
      description: 'Deficiency/Severe Deficiency Status (Likely < 20 ng/mL) - Your responses strongly suggest Vitamin D deficiency. Medical consultation is strongly recommended.',
      ...
      <section className="bg-gradient-to-b from-primary/10 to-background py-12 md:py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
            Vitamin D3 Deficiency Risk Assessment
          </h1>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-amber-700">
                  This is a screening tool and NOT a substitute for a medical diagnosis, which requires a
                  blood test (25-Hydroxyvitamin D test). Always consult healthcare providers for
          ...
          <>
            ...
            <Card className="mb-8 border-l-4 border-l-blue-500 bg-blue-50">
              <CardContent className="pt-6">
                <p className="text-sm text-blue-800">
                  <strong>How this works:</strong> Answer each question below and the calculator will sum
                  up the points to give you a total risk score. This questionnaire is designed
                  specifically for laypersons with typical indoor office environments to estimate their
                  risk of Vitamin D3 deficiency.
                </p>
              </CardContent>
            </Card>
            ...
            <div className="mb-10">
              ...
              <p className="text-muted-foreground text-sm mb-6 italic">
                These factors relate to your body's ability to produce or acquire Vitamin D3, especially
              ...
              <Card className="bg-gradient-primary text-white">
                <CardContent className="pt-6 text-center">
                  ...
                  <p className="text-white/90 mb-4">
                    SuryAmrit™ provides 600 IU of plant-based Vitamin D3 in a traditional ghee base for
                    optimal absorption.
                  </p>
