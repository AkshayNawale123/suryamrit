...
import { ArrowRight, Sun, Shield, Heart, MapPin, Users, TrendingUp, Sparkles, Zap, Leaf, ShoppingCart, Star, ClipboardCheck } from 'lucide-react';
                ...
                <div className="flex flex-col lg:flex-row items-center gap-8">
                  ...
                  <div className="flex-1 text-center lg:text-left">
                    ...
                    <p className="text-muted-foreground text-lg mb-6">
                      Take our quick self-assessment to understand your Vitamin D deficiency risk level and get personalized recommendations.
                    </p>
